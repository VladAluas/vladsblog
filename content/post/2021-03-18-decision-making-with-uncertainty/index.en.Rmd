...
Since we are analysing data we will need a tool that will allow us to do so. I will use *R* since it is a versatile tool that will allow us to create distributions and visualise then quite easily. The code can be completly ignored if you do not want to reproduce or analyse it, you can just focus on the graphs and the results.  If you want to learn more about *R* I would recommend [R for Data Science](https://r4ds.had.co.nz/), a brilliant book that is the perfect starting place.
