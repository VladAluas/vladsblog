...
I will take a look at the numbers in the analysis part, this si just the preparation of the data. Now, let's see if we can estimate how much does an IT professional earn.
...
The fisrt part as for the previous section is quite easy, `r ron_format(11200)`.

If I am to look at the average income across all levels and the fact that managers and directors earn significantly more than everyone else, we can approximate that around 15% of the IT professionals are managers and directors. Otherwise said, I can rephrase this as the following statement: Assuming that I am at an average skill level for the IT industry, by seer luck I will end up in a management position 15% of the time, if I were to live 10,000 lives.
