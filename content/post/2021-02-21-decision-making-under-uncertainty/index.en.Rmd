...
toc: true
=======
>>>>>>> 65fc79639679d3a4c1da58ccfabef750e85c3a26
---
...
knitr::opts_chunk$set(echo = FALSE, comment = "#>", collapse = FALSE, out.width = "100%")
...
dr_sal_mean <- 21100
it_sal_med_high <- 225000
it_sal_med_low  <- 92809
```
...
I have found a data source that seems to have done a pretty good job in assesing the avearage salary for a doctor. The information was taken from the [salaryexplorer.com](http://www.salaryexplorer.com/salary-survey.php?loc=178&loctype=1&job=13&jobtype=2) website. The salary is expressed in the local currency of Romania (RON) and the salaries are expressed before tax. These two impediments are nothing too difficult as we can easily translate everything into Euro, and extract the taxes.
...
But how do I account for that?

The answer is a bit more tricky, however 
